...
- Added generic fluent output creation and source declaration for any `IPlayableOutput`.
- Added edit-mode coverage for `ScriptPlayableOutput` and `AudioPlayableOutput`.

### Changed

- Renamed the public C# namespace and assembly casing to `FluentPlayableApi`.
